    ...
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl '>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg '>
        ...
        { currState === 'Sign up'  && !isDataSubmitted && (
          <input onChange={(e)=>setFullName(e.target.value)} value={fullName}  type="text" name='' id='' className='p-2 border border-gray-500 rounded-md fouse:outline-none ' placeholder='Full Name' required />)}
        ...
        {currState === 'Sign up' && isDataSubmitted && (
          <textarea onChange={(e)=>setbio(e.target.value)} value={bio} raw={4}
          className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'
          placeholder='provide a short bio...' name="" id="" required></textarea>
        )}
